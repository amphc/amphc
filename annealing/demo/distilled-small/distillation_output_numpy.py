...
def gen_beamforming(numSamples: int, pulseDataNoPadding: numpy.ndarray[numpy.complex128][32, 10000], numPulses: int, steerVector1: numpy.ndarray[numpy.complex128][315, 1], steerVector11_1: numpy.ndarray[numpy.complex128][1, 315], numChannels: int) -> numpy.ndarray[numpy.complex128][32, 10000]:
...
def gen_Z(d_matchFilter_1: numpy.ndarray[numpy.complex128][32768], beamforming: numpy.ndarray[numpy.complex128][32, 10000], fftSize: int, numPulses: int, numSamples: int) -> numpy.ndarray[numpy.complex128][128, 32768]:
...
beamforming: numpy.ndarray[numpy.complex128][32, 10000] = gen_beamforming(numSamples, pulseDataNoPadding, numPulses, steerVector1, steerVector11_1, numChannels)

Z: numpy.ndarray[numpy.complex128][128, 32768] = gen_Z(d_matchFilter_1, beamforming, fftSize, numPulses, numSamples)
