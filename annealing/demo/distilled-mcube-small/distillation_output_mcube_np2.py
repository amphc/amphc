...
def gen_Zs(d_matchFilter_1: numpy.ndarray[numpy.complex128][32768], fftSize: int, numPulses: int, numSamples: int, pulseDataNoPadding: numpy.ndarray[numpy.complex128][32, 10000], totalcubes: int, numChannels: int, steerVector1: numpy.ndarray[numpy.complex128][315, 1], steerVector11_1: numpy.ndarray[numpy.complex128][1, 315]) -> numpy.ndarray[numpy.complex128][2, 128, 32768]:
...
Zs: numpy.ndarray[numpy.complex128][2, 128, 32768] = gen_Zs(d_matchFilter_1, fftSize, numPulses, numSamples, pulseDataNoPadding, totalcubes, numChannels, steerVector1, steerVector11_1)
