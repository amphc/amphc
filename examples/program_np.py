import numpy as np
#from pyculib import rand # cuRAND
...
def gen_proc_datacube(weightFunction=None):
    ...
    #out = np.asnumpy(d_out)  # move the array from device to the host
    ...
    # perform Doppler processing across all pulses (Not correct, still need to
    # sort out...)
